    ...
    <div className="min-h-screen pt-16">
      ...
      <section className="py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="glass rounded-3xl shadow-soft overflow-hidden" style={{ height: 'calc(100vh - 350px)', minHeight: '500px' }}>
            <div className="glass-dark px-6 py-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-sm">Always here to listen</p>
                </div>
              </div>
            </div>
                  ...
                  >
                    <div className={`flex items-start space-x-2 max-w-[80%] ${message.sender === 'user' ? 'flex-row-reverse space-x-reverse' : ''}`}>
                      <div className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center ${
                        message.sender === 'ai' ? 'bg-teal-500/20' : 'bg-blue-500/20'
                      }`}>
                        {message.sender === 'ai' ? (
              ...
              <div className="border-t border-white/10 p-4 glass-dark">
                <div className="flex items-end space-x-2">
                  <textarea
                    ...
                    className="flex-1 resize-none rounded-xl border border-white/20 bg-white/5 text-white placeholder:text-gray-400 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                    rows={1}
                  ...
                  <button
                    ...
                    className="btn-primary btn-glow p-3 rounded-xl disabled:opacity-50 disabled:cursor-not-allowed"
                  >
